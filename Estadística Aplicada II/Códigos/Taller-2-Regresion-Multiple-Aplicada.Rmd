...
lib_req<-c("glmnet","lmridge","scatterplot3d","plot3D","plotly","rgl","plot3Drgl",
           ...
           'nlme',"zoom",'ggfortify','readxl','pls')# Listado de librerias requeridas por el script
...
Antes de proceder a realizar el análisis del resumen del modelo procederemos a evaluar los grados de multicolinealidad en comparación con el modelo con regresión de ñasso y la respectiva validación de supuestos.
...
Por último procedemos a realizar las interpretaciones del modelo por regresión de ridge luego de corregir el problema de multicolinealidad donde no evidenciamos cambios notorios en las pendientes de los sino $\beta_{j}$ en sus errores estandar que era de esperarse.
