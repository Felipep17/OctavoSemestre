...
hist(studres(model),lwd=2,col='aquamarine4',freq=F,ylim=c(0,0.4),xlab='Residuos Estudentizados Modelo',main='')
...
hist(studres(model.box),lwd=2,col='aquamarine4',freq=F,ylim=c(0,0.4),xlab='Residuos Estudentizados Modelo',main='')
