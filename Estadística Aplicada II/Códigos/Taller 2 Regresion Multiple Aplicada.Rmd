...
Como se establecio anteriormente, se asume un modelo de regresión usual, el cual debe cumplir los siguientes supuestos: E(y|x)=$x^T\beta$, y V(y|x)=$\sigma^2$, por ende es necesario proponer un modelo con p<n, en el cual se eliminaran las variables con menor correlación con la variable y. Dicho modelo se expresa acontinuación y se evaluan los supuestos:
...
lambda(model,-3,3)
model.box <- lm(I(density^0.95) ~.-NIR1-NIR8-NIR9-NIR10-NIR11-NIR7,data=X)
